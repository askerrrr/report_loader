...
var periodsFilter = async (req, res, next) => {
  ...
  var { reportsQueue, failedReports } = await db.getUser(userId);
  var filteredRequiredReportPeriods = filterAlreadyFailedReports(failedReports, requiredReportPeriods)
